...
export default defineConfig({
    base: "/soft-home-work/",
    title: "soft-home-work docs",
    description: "A docs for soft-home-work create by cbq1024",
    markdown: {
        math: true,
        lineNumbers: true
    },
    ...
    themeConfig: {
        head: [["link", {rel: "icon", href: "/soft-home-work/mcdd.jpg"}]],
        outline: [2, 4],
        lastUpdated: true,
        ...
        nav: [
            ...
            },
            {
                ...
                items: [
                    ...
                    {text: '👿 部署', link: '/dev-tools/dev-ops/index.md'},
